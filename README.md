...
| No | Library | Function |
| :--- | :--- | :--- |
| 1 | **Pandas** | High-performance tools for tabular data manipulation and metadata analysis. |
| 2 | **NumPy** | Fundamental package for numerical operations and multi-dimensional array processing. |
| 3 | **Seaborn** | Statistical data visualization library built on top of Matplotlib for informative graphics. |
| 4 | **Matplotlib** | Core framework for creating static, animated, and interactive visualizations. |
| 5 | **Scipy** | Advanced modules for calculating data skewness and performing complex statistical tests. |
| 6 | **Statsmodels** | Comprehensive library for estimating and interpreting various statistical models like Regression and ANOVA. |
